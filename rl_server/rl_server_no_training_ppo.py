...
# NN_MODEL = None
NN_MODEL = '../rl_server/results/ppo_log_ep_52700.ckpt'
...
def run(server_class=HTTPServer, port=8002, log_file_path=LOG_FILE):
    ...
    with tf.compat.v1.Session() as sess, open(log_file_path, 'wb') as log_file:
        ...
        input_dict = {'sess': sess, 'log_file': log_file,
                      'actor': actor, 'saver': saver, 'train_counter': train_counter,
